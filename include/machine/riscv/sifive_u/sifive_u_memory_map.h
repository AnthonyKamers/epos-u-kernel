...
public:
    enum : unsigned long {
        ...
        // TODO check the last page, which is necessary for machine trap handler
        ...
        BOOT_STACK      = Traits<Machine>::BOOT_STACK, // LAST_PAGE - Traits<Machine>::STACK_SIZE, // will be used as the stack's base, not the stack pointer
